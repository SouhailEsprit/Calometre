...
return [
    ...
    'recette_pdf' => [['id'], ['_controller' => 'App\\Controller\\ReceFrontController::getPDF'], [], [['variable', '/', '[^/]++', 'id']], [], []],
    ...
    'app_recette_p_d_f' => [[], ['_controller' => 'App\\Controller\\RecettePDFController::index'], [], [['text', '/recette/p/d/f']], [], []],
