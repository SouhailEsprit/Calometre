...
return [
    ...
    'recette_pdf' => [['id'], ['_controller' => 'App\\Controller\\ReceFrontController::getPDF'], [], [['text', '/pdf'], ['variable', '/', '[^/]++', 'id']], [], []],
    'recette_like' => [['id'], ['_controller' => 'App\\Controller\\ReceFrontController::like'], [], [['text', '/like'], ['variable', '/', '[^/]++', 'id'], ['text', '/rece/front']], [], []],
