...
class __TwigTemplate_3889674dc3a5ace4e9f96379a7dd2a7ca4466db89f3cde8d8ca709ed969f5b9e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('aliment_delete', {'id': aliment.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ aliment.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "aliment/_delete_form.html.twig", "C:\\Users\\Ahmed Mahjoub\\Calometre\\templates\\aliment\\_delete_form.html.twig");
    }
}
