 ...
 */
final class Version20220225214437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP commentauthor');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE comment ADD commentauthor VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE commentcontent commentcontent VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
